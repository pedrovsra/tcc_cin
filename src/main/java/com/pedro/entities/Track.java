...
public class Track {
	...
	public Track(SimpleAlbum album, List<SimpleArtist> artists, List<String> availableMarkets, int discNumber,
			int duration, boolean explicit, ExternalIds externalIds, ExternalUrls externalUrls, String href, String id,
			String name, int popularity, String previewUrl, int trackNumber, SpotifyDataType type, String uri) {
		super();
		this.album = album;
