...
public class Main {
	...
	private static void run(HttpRequestFactory requestFactory) throws IOException {
		SpotifyUrl url = new SpotifyUrl("https://api.spotify.com/v1/audio-analysis/6GyDY0yE47rfk8pcuKhioh");
		HttpRequest request = requestFactory.buildGetRequest(url);
		AudioAnalysis a = request.execute().parseAs(AudioAnalysis.class);
